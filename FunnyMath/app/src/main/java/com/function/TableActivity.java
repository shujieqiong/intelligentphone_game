...
public class TableActivity extends Activity  {
    ...
    private void InitViewPager() {
        ...
        page0 = mInflater.inflate(R.layout.table_pager, null);
        page1 = mInflater.inflate(R.layout.table_pager, null);
        page2 = mInflater.inflate(R.layout.table_pager, null);
        page3 = mInflater.inflate(R.layout.table_pager, null);
        page4 = mInflater.inflate(R.layout.table_pager, null);
        page5 = mInflater.inflate(R.layout.table_pager, null);
        page6 = mInflater.inflate(R.layout.table_pager, null);
        page7 = mInflater.inflate(R.layout.table_pager, null);
        page8 = mInflater.inflate(R.layout.table_pager, null);
        page9 = mInflater.inflate(R.layout.table_pager, null);
        listViews.add(page0);
        listViews.add(page1);
        listViews.add(page2);
        listViews.add(page3);
...
//					setData();
    ...
    public void setData() {
        ...
        textView.setText(tableData.getQuestion());
        setRightFlag(random.nextInt(4) + 1);
        switch (rightFlag) {
            case 1:
                radioButtonA.setText("" + tableData.getAnswer());
                radioButtonB.setText("" + tableData.getAnswer1());
                radioButtonC.setText("" + tableData.getAnswer2());
                radioButtonD.setText("" + tableData.getAnswer3());
                break;
            case 2:
                radioButtonB.setText("" + tableData.getAnswer());
                radioButtonA.setText("" + tableData.getAnswer1());
                radioButtonC.setText("" + tableData.getAnswer2());
                radioButtonD.setText("" + tableData.getAnswer3());
                break;
            case 3:
                radioButtonC.setText("" + tableData.getAnswer());
                radioButtonA.setText("" + tableData.getAnswer1());
                radioButtonB.setText("" + tableData.getAnswer2());
                radioButtonD.setText("" + tableData.getAnswer3());
                break;
            case 4:
                radioButtonD.setText("" + tableData.getAnswer());
                radioButtonA.setText("" + tableData.getAnswer1());
                radioButtonB.setText("" + tableData.getAnswer2());
                radioButtonC.setText("" + tableData.getAnswer3());
                break;
        }
        //给radioGroup添加监听器
    ...
    private void initAddPage(View view) {
        textView = (TextView) view.findViewById(R.id.table_textView);
        radioGroup = (RadioGroup) view.findViewById(R.id.table_radioGroup);
        radioButtonA = (RadioButton) view.findViewById(R.id.table_radioButtonA);
        radioButtonB = (RadioButton) view.findViewById(R.id.table_radioButtonB);
        radioButtonC = (RadioButton) view.findViewById(R.id.table_radioButtonC);
        radioButtonD = (RadioButton) view.findViewById(R.id.table_radioButtonD);
        ...
        imageView_teach.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(
                        TableActivity.this);
                builder.setTitle("表内乘除法：");
                builder.setMessage("理解乘法口诀的意义，能较熟练地用数字的乘法口诀来计算试题的积或商，会用口诀解决简单地实际问题。");
