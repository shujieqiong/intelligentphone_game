...
public class shujiaotishi extends Activity {////////每创建一个Activity,要在清单文件一定要声明这个CLASS文件
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.shujiaoaa);//将xml文件引入到class文件中
    ...
    private void InitViewPager() {
        ...
        page0 = mInflater.inflate(R.layout.sanjiaotishi, null);
        page1 = mInflater.inflate(R.layout.sanjiaotishi1, null);
